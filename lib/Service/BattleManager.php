  ...
  */
  public function battle(AbstractShip $ship1, $ship1Quantity, AbstractShip $ship2, $ship2Quantity, $battleType)
  {
    ...
    while ($ship1Health > 0 && $ship2Health > 0) {
        ...
        //check to make sure it's not infinite loop, otherwise the ship will fight forever
        //shet both ship1health and ship2health to zero
        if ($i == 100) {
          $ship1Health = 0;
          $ship2Health = 0;
        }
  ...
  public static function getBattleTypeWithDescription()
  {
    return array(
